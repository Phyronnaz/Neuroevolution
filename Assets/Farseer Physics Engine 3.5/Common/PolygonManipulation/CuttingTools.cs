        ...
        public static bool Cut(World world, Vector2 start, Vector2 end)
        {
            ...
            for (int i = 0; i < fixtures.Count; i++)
            {
                ...
                if (fixtures[i].Body.BodyType != BodyType.Static)
                {
                    ...
                    {
                        Body firstFixture = BodyFactory.CreatePolygon(world, first, fixtures[i].Shape.Density, fixtures[i].Body.Position, null);
                    ...
                    {
                        Body secondFixture = BodyFactory.CreatePolygon(world, second, fixtures[i].Shape.Density, fixtures[i].Body.Position, null);
